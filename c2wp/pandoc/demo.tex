...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={John MacFarlane 這是作者},
            pdftitle={Pandoc User's Guide 這是文章標題},
            colorlinks=true,
            citecolor=blue,
            urlcolor=blue,
            linkcolor=magenta,
...
\begin{figure}[htbp]
\centering
\includegraphics{/images/set-operations-illustrated-with-venn-diagrams.png}
...
可以說 Pandoc is a \href{http://www.haskell.org/}{Haskell} library for
...
\hyperdef{}{epub-metadata}{\section{EPUB Metadata}\label{epub-metadata}}
...
\hyperdef{}{custom-writers}{\section{Custom
