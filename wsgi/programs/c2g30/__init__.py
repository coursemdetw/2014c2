#@+leo-ver=5-thin
#@+node:2014spring.20140519152219.2033: * @file __init__.py
#@@language python
#@@tabwidth -4

#@+<<declarations>>
#@+node:2014spring.20140519152219.2034: ** <<declarations>> (__init__)
import cherrypy
#@-<<declarations>>
#@+others
#@+node:2014spring.20140519152219.2035: ** class C2G30
# 這是 C2G30 類別的定義
class C2G30(object):
    # 各組利用 index 引導隨後的程式執行
    #@+others
    #@+node:2014spring.20140519152219.2036: *3* index
    @cherrypy.expose
...
'''
        return outstring
    #@+node:2014spring.20140519152219.2037: *3* fillpoly
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2038: *3* drawline
    ''' 
    假如採用下列規畫
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2039: *3* animate1
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2040: *3* flag
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2041: *3* square
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2042: *3* star
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2043: *3* w13_1_1
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2044: *3* w13_1_2
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2045: *3* w13_1_3
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2046: *3* w13_1_4
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2047: *3* w13_1_5
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2074: *3* w13_1_6
    ...
    '''
        return outstring
    #@+node:2014spring.20140519152219.2048: *3* w13_1_7
