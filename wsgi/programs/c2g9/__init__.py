...
<a href=" American_flag2014c2_1 ">c2g9 American_flag2014c2_1  繪圖</a><br />
<a href=" American_flag2014c2_2 ">c2g9 American_flag2014c2_2  繪圖</a><br />
<a href=" American_flag2014c2_3 ">c2g9 American_flag2014c2_3  繪圖</a><br />
'''
        return outstring
    ...
    '''
        return outstring
    @cherrypy.expose
    def American_flag2014c2_1 (self, *args, **kwargs):
        '''
        原始程式來源: http://blog.roodo.com/esabear/archives/19215194.html
        改寫為 Brython 程式
        '''
    ...
    '''
        return outstring
    @cherrypy.expose
    def American_flag2014c2_2 (self, *args, **kwargs):
        '''
        原始程式來源: http://blog.roodo.com/esabear/archives/19215194.html
        改寫為 Brython 程式
        '''
    ...
    '''
        return outstring
    @cherrypy.expose
    def American_flag2014c2_3 (self, *args, **kwargs):
        '''
        原始程式來源: http://blog.roodo.com/esabear/archives/19215194.html
        改寫為 Brython 程式
        '''
